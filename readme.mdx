...
This example uses [Railway](https://railway.com?referralCode=pa1ar) templates. 
...
- [Railway account](https://railway.com?referralCode=pa1ar) (free trial is 30 days or $5)
...
1. Fork this [repository](https://github.com/masumi-network/agentic-service-wrapper)
